...
- [ ] T5A3: G18 history/access and append-only correction integration passes on Fake.
  ...
  EVIDENCE: complete (recorded_correction half added by integration part 2); exit=0; shell=/bin/sh; cwd=/Users/mascott/projects/hippo/.worktrees/t5a2; branch=wp/t5a2; output=................................................ [100%] | 48 passed, 53 deselected in 0.81s; supersedes the part 1 partial line (23 passed, its detail is preserved in evidence-int1.md); the 25 new cases cover plan shape, closure/append validation, six failpoint rollback positions, idempotent retry, compatibility-path rejection, per-cutoff history selection and the N2 per-series supersession; detail=ai_docs/gates/rag-it-all/task-5a-temporal-conflicts/evidence-int2.md
...
- [ ] T5A4: G18 storage behavior survives a real Ladybug close/reopen.
  ...
  EVIDENCE: complete (recorded_correction half added by integration part 2); exit=0; shell=/bin/sh; cwd=/Users/mascott/projects/hippo/.worktrees/t5a2; branch=wp/t5a2; output=................................................ [100%] | 48 passed, 53 deselected in 117.60s; supersedes the part 1 partial line (23 passed, its detail is preserved in evidence-int1.md); real close/reopen after a correction publication covered by tests/unit/test_generation_store.py::test_recorded_correction_survives_a_ladybug_close_and_reopen (HIPPO_TEST_STORE=ladybug ... test_generation_store.py -> 35 passed in 26.13s); detail=ai_docs/gates/rag-it-all/task-5a-temporal-conflicts/evidence-int2.md
