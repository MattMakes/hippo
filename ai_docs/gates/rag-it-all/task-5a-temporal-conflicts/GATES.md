...
Status (2026-09-12, after integration part 2): T5A1/T5A2/T5A5/T5A6 complete; T5A3/T5A4 now cover history_manifest, suppression_history, purge_history AND recorded_correction (append-only correction publication with six failpoints). Still owed before Task 5A closes: chronological JSONL fixture loading, the root-only disposable-Neo4j repeat of the publication/CAS/conflict cases, and the independent review of part 2.
...
- [ ] T5A3: G18 history/access and append-only correction integration passes on Fake.
  ...
  EVIDENCE: complete (recorded_correction half added by integration part 2, extended by the post-review fixes F1-F6); exit=0; shell=/bin/sh; cwd=/Users/mascott/projects/hippo/.worktrees/t5a2fix; branch=wp/t5a2fix; output=......................................................... [100%] | 57 passed, 53 deselected in 0.84s; supersedes the part 1 partial line (23 passed) and the part 2 line (48 passed), whose detail is preserved in evidence-int1.md and the part 2 section of evidence-int2.md; the 9 further cases pin the publication capability that authorizes a recorded closure (F1), the proof-group enforcement and the plan's own dependency check (F2), a closure target the publishing generation carries (F3), a closure target corroborated by a second source (F4), byte-identical rollback at every failpoint (F5) and a stale build fence (F6); detail=ai_docs/gates/rag-it-all/task-5a-temporal-conflicts/evidence-int2.md
...
- [ ] T5A4: G18 storage behavior survives a real Ladybug close/reopen.
  ...
  EVIDENCE: complete (recorded_correction half added by integration part 2, extended by the post-review fixes F1-F6); exit=0; shell=/bin/sh; cwd=/Users/mascott/projects/hippo/.worktrees/t5a2fix; branch=wp/t5a2fix; output=......................................................... [100%] | 57 passed, 53 deselected in 100.58s; supersedes the part 1 partial line (23 passed) and the part 2 line (48 passed), whose detail is preserved in evidence-int1.md and the part 2 section of evidence-int2.md; real close/reopen after a correction publication still covered by tests/unit/test_generation_store.py::test_recorded_correction_survives_a_ladybug_close_and_reopen (HIPPO_TEST_STORE=ladybug ... test_generation_store.py -> 35 passed in 26.30s); detail=ai_docs/gates/rag-it-all/task-5a-temporal-conflicts/evidence-int2.md
