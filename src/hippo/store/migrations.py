...
SUPPORTED_CHECKSUMS = {1: V1_CHECKSUM, 2: V2_CHECKSUM, 3: V3_CHECKSUM, 4: MIGRATION_CHECKSUM}
...
def _descriptor(version):
    ...
    if version == 4:
        return [4, KNOWLEDGE_COLUMNS, KNOWLEDGE_RELATIONS, SOURCE_COLUMNS, PASSAGE_COLUMNS, NATIVE_COLUMNS]
